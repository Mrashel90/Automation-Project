...
public class Reusable_Library_Loggers {
    ...
    public static void mouseHover(WebDriver driver, String locator,ExtentTest loggers,String elementName) throws IOException {
    ...
    public static void click(WebDriver driver, String locator, ExtentTest loggers, String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver,10);
        try{
    ...
    public static void clickByIndex(WebDriver driver, String locator, int indexNumber, ExtentTest loggers,String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver,10);
        try{
            System.out.println("Clicking on element " + elementName);
            loggers.log(LogStatus.INFO,"Clicking on element " + elementName);
    ...
    public static void userInput(WebDriver driver, String locator, String userValue, ExtentTest loggers,String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver,10);
        try {
    ...
    public static String captureTextByIndex(WebDriver driver, String locator, int index, ExtentTest loggers, String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver,10);
        String text = null;
        try{
    ...
    public static void dropDownByText(WebDriver driver, String locator, String userValue, ExtentTest loggers,String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver,10);

...
public class ActionItem_Express_Loggers extends Abstract_Class {
    ...
    @Test
    public void clickOnMeeting() throws InterruptedException, WriteException, IOException, BiffException {
        ...
        for (int i = 1; i < 3; i++) {
            ...
            //24.Choose state
            Reusable_Library_Loggers.dropDownByText(driver, "//*[contains(@name='shipping.state']", state, logger, "State");
